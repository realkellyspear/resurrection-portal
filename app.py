...
st.markdown("""
<style>
    body, .stApp { background-color: #0d0d0d !important; color: #33ff00 !important; font-family: 'Courier New', monospace !important; }
    .stApp::after {
    ...
    h1, h2, h3 { color: #33ff00 !important; text-transform: uppercase; letter-spacing: 2px; border-bottom: 2px solid #33ff00; }
    .stButton>button { background-color: #33ff00 !important; color: #000 !important; border: 2px solid #33ff00 !important; font-weight: bold; text-transform: uppercase; }
    .stButton>button:hover { background-color: #000 !important; color: #33ff00 !important; border: 2px solid #33ff00 !important; }
    .upload-area { border: 2px dashed #33ff00 !important; background: rgba(51,255,0,0.05) !important; padding: 30px; text-align: center; }
    .success-box { border: 2px solid #33ff00; background: rgba(51,255,0,0.1); padding: 20px; text-align: center; font-size: 1.2em; }
